...
std::ostream& operator<<(std::ostream& os, FrameworkEvent::Type eventType)
{
  switch (eventType)
  {
  case FrameworkEvent::Type::STARTING:       return os << "STARTING";
  case FrameworkEvent::Type::STARTED:        return os << "STARTED";
  case FrameworkEvent::Type::ERROR:			 return os << "ERROR";
  case FrameworkEvent::Type::INFO:           return os << "INFO";
  case FrameworkEvent::Type::WARNING:        return os << "WARNING";
  case FrameworkEvent::Type::STOPPED:        return os << "STOPPED";
  case FrameworkEvent::Type::STOPPING:       return os << "STOPPING";
  case FrameworkEvent::Type::WAIT_TIMEDOUT:  return os << "WAIT TIMED OUT";
